...
<div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
    ...
    <p class="text-sm text-gray-400 mt-2">Desarrollo web</p>

    <img src="{{ asset('images/dev.png') }}" class=" absolute -right-20 -bottom-20 opacity-50">
</div>

<div class="px-4">
    <h1 class="text-2xl mb8 text-gray-900">Contenido Tecnico</h1>
